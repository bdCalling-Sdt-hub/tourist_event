...
const ResetPassword = () => {
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = (values) => {
        ...
        reset({ email: localStorage.getItem('email'), data: values }).unwrap()
            .then(result => {
            ...
            <div className='w-full h-full grid-2'>
                ...
                <div className='flex justify-center items-start h-full w-full flex-col bg-[var(--color-blue-200)] p-4'>
                    <div className='max-w-[600px] w-full mx-auto'>
                        ...
                        <p className='text-gray'>Your previous password has been reseed. Please set a new password for your account.</p>
                        <Form
                            layout='vertical'
