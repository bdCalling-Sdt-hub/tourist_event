...
const EventAddEditForm = ({
  ...
  useEffect(() => {
    ...
    // }
    setLocationData({
      lat: data?.data?.location_map?.coordinates?.[0],
      lng: data?.data?.location_map?.coordinates?.[1],
  ...
  return (
    <div className="p-4">
      ...
      >
        ...
        <Form.Item<FieldType> label="Social Media Link" name="social_media">
        ...
        <Form.Item<FieldType> label="Recurrence" name="recurrence">
          <Select
            defaultValue={renew}
            value={renew}
